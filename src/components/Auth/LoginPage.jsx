...
import './LoginSuccessAnimation.css'; // Import the CSS for animation
...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Succesfully Logged in ${email} Welcome to Osamedic's Care`)
        ...
        <div className="w-full p-10 md:ml-10 max-w-md px-6 py-8 bg-white shadow-lg rounded-xl">
          {success ? (
            <div className="success-animation">
              <span className="success-icon">&#10004;</span> {/* Checkmark icon */}
              <p className="text-green-500 text-lg mt-4">Login successful! Redirecting...</p>
            </div>
          ) : (
