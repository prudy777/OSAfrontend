...
import { Container, Typography, Grid2, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Button, TextField, Select, MenuItem, Checkbox, FormControlLabel, Fade } from '@mui/material';
...
const AccountingPage = () => {
  ...
  return (
    <Fade in={true} timeout={1000} appear>
      <Container maxWidth={false} sx={{ marginTop: 40, maxWidth: '1500px', width: '1500px', opacity: 1, transition: 'opacity 1s ease-out', transform: 'translate3d(0, 0, 0)' }}>
        <Paper sx={{ padding: 4 }}>
